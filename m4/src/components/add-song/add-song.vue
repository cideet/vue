        ...
        <div class="add-song" v-show="showFlag" @click.stop>
            ...
            <div class="shortcut" v-show="!query">
                ...
                <div class="list-wrapper">
                    <v-scroll ref="songList" v-if="currentIndex === 0" :data="playHistory" class="list-scroll">
                        <div class="list-inner">
                            <v-song-list :songs="playHistory" @select="selectSong"></v-song-list>
                        </div>
                    </v-scroll>
                    <v-scroll ref="searchList" :refreshDelay="refreshDelay" class="list-scroll"
                              v-if="currentIndex === 1" :data="searchHistory">
                        <div class="list-inner">
                            <v-search-list @delete="deleteSearchHistory" @select="setQuery"
            ...
            <div class="search-result" v-show="query">
                <v-suggest :query="query" :showSinger="showSinger" @select="selectSuggest"
