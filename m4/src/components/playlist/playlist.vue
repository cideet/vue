        ...
        <div class="playlist" v-show="showFlag" @click="hide">
            ...
            <span class="clear" @click="showConfirm">
              <i class="icon-clear"></i>
                ...
                <v-scroll ref="listContent" class="list-content" :data="sequenceList" :refreshDelay="refreshDelay">
            ...
            <v-confirm ref="confirm" text="是否清空播放列表" confirmBtnText="清空" @confirm="confirmClear"></v-confirm>
